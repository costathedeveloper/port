      ...
      <div className="py-4 px-2 mx-auto max-w-screen-xl sm:py-4 lg:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4 h-full">
          <div className="col-span-2 sm:col-span-1 md:col-span-2 h-auto md:h-full flex flex-col">
            <a href="/best-time-to-visit" className="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40 flex-grow">
              ...
              <h3 className="z-10 text-xl font-medium text-white absolute top-0 left-0 p-4 xs:text-xl">Best Time To Visit</h3>
            </a>
          </div>
          <div className="col-span-2 sm:col-span-1 md:col-span-2">
            <a href="/how-to-get-there" className="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40 mb-4">
              ...
              <div className="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
              <h3 className="z-10 text-xl font-medium text-white absolute top-0 left-0 p-4 xs:text-xl">How To Get There</h3>
            </a>
            <div className="grid gap-4 grid-cols-2 sm:grid-cols-2 lg:grid-cols-2">
              <a href="/accommodation" className="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40">
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
                <h3 className="z-10 text-xl font-medium text-white absolute top-0 left-0 p-4 xs:text-xl">Accommodation</h3>
              </a>
              <a href="/cape-town-beaches" className="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40">
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
                <h3 className="z-10 text-xl font-medium text-white absolute top-0 left-0 p-4 xs:text-xl">Cape Town Beaches & Ocean</h3>
              </a>
            </div>
          </div>
          <div className="col-span-2 sm:col-span-1 md:col-span-1  h-auto md:h-full flex flex-col">
            <a href="/things-to-do-in-cape-town" className="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40 flex-grow">
              ...
              <div className="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
              <h3 className="z-10 text-xl font-medium text-white absolute top-0 left-0 p-4 xs:text-xl">Things To Do In Cape Town</h3>
            </a>
          </div>
        </div>
      </div>
