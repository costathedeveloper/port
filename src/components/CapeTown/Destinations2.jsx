      ...
      <div className="py-4 px-2 mx-auto max-w-screen-xl sm:py-4 lg:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4 h-full">
          <div className="col-span-2 sm:col-span-1 md:col-span-2 h-auto md:h-full flex flex-col">
            <a href="/aquila" className="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40 flex-grow">
              ...
              <h3 className="z-10 text-xl font-medium text-white absolute top-0 left-0 p-4 xs:text-xl">Aquila Private Game Reserve</h3>
            </a>
          </div>
          <div className="col-span-2 sm:col-span-1 md:col-span-2">
            <a href="/table-mountain" className="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40 mb-4">
              ...
              <div className="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
              <h3 className="z-10 text-xl font-medium text-white absolute top-0 left-0 p-4 xs:text-xl">Table Mountain National Park</h3>
            </a>
            <div className="grid gap-4 grid-cols-2 sm:grid-cols-2 lg:grid-cols-2">
              <a href="/kirstenbosch-botanical-gardens" className="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40">
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
                <h3 className="z-10 text-xl font-medium text-white absolute top-0 left-0 p-4 xs:text-xl">Kirstenbosch Botanical Gardens</h3>
              </a>
              <a href="/victoria-and-alfred-waterfront" className="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40">
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
                <h3 className="z-10 text-xl font-medium text-white absolute top-0 left-0 p-4 xs:text-xl">Victoria And Alfred Waterfront</h3>
              </a>
            </div>
          </div>
          <div className="col-span-2 sm:col-span-1 md:col-span-1  h-auto md:h-full flex flex-col">
            <a href="/cape-of-good-hope" className="group relative flex flex-col overflow-hidden rounded-lg px-4 pb-4 pt-40 flex-grow">
              ...
              <div className="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
              <h3 className="z-10 text-xl font-medium text-white absolute top-0 left-0 p-4 xs:text-xl">Cape Of Good Hope</h3>
            </a>
          </div>
        </div>
      </div>
